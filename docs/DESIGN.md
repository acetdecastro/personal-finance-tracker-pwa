...
If an element _must_ float (e.g., a bottom sheet or a floating action button), use a **Tinted Shadow**:
...
- **Don't Over-Color:** If everything is Emerald, nothing is important. Use Emerald for _actions_ and _growth_; use Slate/Zinc for _structure_.
